...
| Productivity | 🟡 in corso | **Installato cmdk**. Next: command palette ⌘+K con ricerca articoli/prompt/utenti + keyboard shortcuts (j/k/?/g+s) + onboarding tour react-joyride + optimistic UI + typed-confirmation destructive |
