...
export const PromptsListPage = lazy(
  () => import('@/pages/prompts/PromptsListPage'),
);
export const PromptDetailPage = lazy(
  () => import('@/pages/prompts/PromptDetailPage'),
);
...
export const TaxonomyPage = lazy(
...
export const ForbiddenPage = lazy(
  () => import('@/pages/errors/ForbiddenPage'),
);
