// ---------------------------------------------------------------------------
// TaxonomyPage — versione "Coming Soon" temporanea.
//
// La versione completa (tabs Categorie/Tag + sync WP + CRUD) è preservata in
// `_TaxonomyPage.full.tsx` e può essere riattivata sostituendo l'import nel
// router / LazyPages o rinominando questo file.
// ---------------------------------------------------------------------------
    ...
    <div style={{ maxWidth: 960, margin: '0 auto' }}>
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          >
            <FolderTree size={34} strokeWidth={2} />
          </div>
        ...
        <div style={{ flex: 1, minWidth: 240 }}>
          ...
          <div>
            <Text type="secondary" style={{ fontSize: 12 }}>
              Categorie e tag continuano a sincronizzarsi in background da WordPress. Appena la
              pagina sarà live potrai gestirli direttamente da qui.
            </Text>
          </div>
        </div>
